...
class ApiLambdaJwtStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    api.root.addResource('{menu}').addMethod('GET', new HttpIntegration(`${lbEndpoint}/{menu}`, {
      options: {
        requestParameters: {
          "integration.request.path.menu": "method.request.path.menu",
        }, 
      },
      proxy: false,
    }),
